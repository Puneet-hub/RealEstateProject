...
const FeaturedProperties = () => {
  return (
    <section id="featured" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-100 px-4 sm:px-6 md:px-8">
      <div className="max-w-6xl mx-auto">
        <h4 className="text-xs sm:text-sm uppercase tracking-widest text-gray-500 mb-1 sm:mb-2">
            ...
            >
              <div className="relative group">
                <img
                  src={property.image}
                  alt={property.title}
                  className="w-full h-48 sm:h-56 md:h-64 object-cover transition duration-300 group-hover:opacity-80"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-black opacity-0 group-hover:opacity-80 transition flex justify-center items-center">
                  <button className="text-white border border-white px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm rounded hover:bg-white hover:text-black transition">
                    View Property
                  </button>
                </div>
              </div>
              <div className="p-3 sm:p-4">
                <p className="text-sm sm:text-base md:text-lg font-semibold text-gray-800">
                  <span className="block sm:inline">{property.title}</span>{' '}
                  <span className="text-gray-500 font-medium block sm:inline mt-1 sm:mt-0">
                    | {property.location}
                  </span>
                </p>
              </div>
        ...
        <div className="text-center mt-8 sm:mt-10 md:mt-12">
          <Link
            to="/allproperties"
            className="inline-block px-6 sm:px-8 py-2.5 sm:py-3 bg-black text-white text-xs sm:text-sm uppercase tracking-widest rounded-lg hover:bg-gray-800 hover:shadow-lg transition duration-300"
          >
            View All Properties
          </Link>
        </div>
