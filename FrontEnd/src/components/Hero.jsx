  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-white px-4 sm:px-6 md:px-8">
        ...
        <Link
          to="/allproperties"
          className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-3.5 text-sm sm:text-base rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
        >
