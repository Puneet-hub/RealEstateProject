...
const Commercial = () => {
  ...
  return (
    <div className="min-h-screen pt-24 px-6 bg-gray-50">
      <h2 className="text-4xl font-bold text-center mb-10">Commercial Properties</h2>
        ...
        {listings.map((item) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <a
                href="/contact"
                className="inline-block mt-2 bg-black text-white px-4 py-2 rounded hover:bg-gray-800 transition"
              >
                Book Visit
              </a>
            </div>
      ...
      {/* 🔹 CTA Section */}
<div className="text-center mt-16 mb-20 px-4 sm:px-0">
  ...
  <a
    href="/contact"
    className="inline-block bg-blue-600 text-white text-lg font-medium px-8 py-3 rounded-full hover:bg-blue-700 hover:shadow-lg transition duration-300"
  >
    Contact Our Experts
  </a>
</div>
